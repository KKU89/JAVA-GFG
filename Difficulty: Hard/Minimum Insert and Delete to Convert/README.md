<h2><a href="https://www.geeksforgeeks.org/problems/minimum-insertions-to-make-two-arrays-equal/1?_gl=1*1r39ayc*_up*MQ..*_gs*MQ..&gclid=CjwKCAjw0o3SBhBVEiwAh28-jZPzvM7Q91T8h1elV70N6AVbFmjys_d-s0SeXxdEan3TJr72bqOlOBoCD-gQAvD_BwE&gbraid=0AAAAAC9yBkDAS1AgSK1LfLRH5z6DgITje">Minimum Insert and Delete to Convert</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two arrays <strong>a[]</strong> and <strong>b[] </strong>of size n and m respectively, find the minimum number of <strong>insertions </strong>and <strong>deletions </strong>on the array a[], required to make both the arrays <strong>identical</strong>.</span></p>
