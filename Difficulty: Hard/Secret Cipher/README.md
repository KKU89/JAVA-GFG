<h2><a href="https://www.geeksforgeeks.org/problems/secret-cipher--141631/1?_gl=1*1socd1*_up*MQ..&gclid=Cj0KCQjwv4XUBhDBARIsAE6bQUTNsCvINIoyz-7l4ARcPGEnePPYTgbKI5Z_8NH_UQDrz5VNgJ64Rk4aAqUhEALw_wcB&gbraid=0AAAAAC9yBkAmv5J7AxST4AFKo5x_ElrPS">Secret Cipher</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p class="PDq2pG_selectionAnchorContainer" data-start="23" data-end="177"><span style="font-size: 14pt;">Geek wants to send a secret message to his friend Keeg. Instead of sending the original message directly, he encrypts it by inserting the character '*'.</span></p>
