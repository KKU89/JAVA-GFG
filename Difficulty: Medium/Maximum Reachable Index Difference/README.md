<h2><a href="https://www.geeksforgeeks.org/problems/maximum-reachable-index-difference/1?_gl=1*mib6dd*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwsfzSBhB5EiwAOGyqSdhAE1im8bEC7vhnVvbaHhp0hTsMU4kQkc17n3LxI3HjF17aRPwv6xoCb6AQAvD_BwE&gbraid=0AAAAAC9yBkDlZBbRpCLweiCmWVqUHB40j">Maximum Reachable Index Difference</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a string <strong>s</strong> containing lowercase English alphabets.</span></p>
<ul>
