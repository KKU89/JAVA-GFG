<h2><a href="https://www.geeksforgeeks.org/problems/minimum-cost-to-fill-given-weight-in-a-bag1956/1?_gl=1*14cbssx*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwxb7RBhA5EiwAQ-AAdJD-H6mDxcvG0_STOoqY1pBp8PSvuX73xcPhJ0DFCVABOGeLs-gPrBoC_8QQAvD_BwE&gbraid=0AAAAAC9yBkBmcQrcJ5wKWl3aMVtqEpi5f">Minimum Cost to Fill Given Weight</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a bag of size w kg and you are provided costs of packets different weights of oranges in array cost[], find the minimum total cost to buy exactly w kg oranges<br></span></p>
<ul>
